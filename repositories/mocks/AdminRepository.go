...
func (_m *AdminRepository) Create(adminReq models.Admin) (models.Admin, error) {
...
func (_m *AdminRepository) Update(adminReq models.Admin, id string) (models.Admin, error) {
	...
	var r0 models.Admin
	var r1 error
	if rf, ok := ret.Get(0).(func(models.Admin, string) (models.Admin, error)); ok {
		return rf(adminReq, id)
	}
	if rf, ok := ret.Get(0).(func(models.Admin, string) models.Admin); ok {
		r0 = rf(adminReq, id)
	} else {
		r0 = ret.Get(0).(models.Admin)
	}

	if rf, ok := ret.Get(1).(func(models.Admin, string) error); ok {
		r1 = rf(adminReq, id)
	} else {
		r1 = ret.Error(1)
	}
